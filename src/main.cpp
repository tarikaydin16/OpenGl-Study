...
{ 
    ...
    GLFWwindow* window = glfwCreateWindow(800,600,"İLk mainn",NULL,NULL);
    ...
    program.attachShader("../../ders3/shaders/simplevs.glsl",GL_VERTEX_SHADER);
    program.attachShader("../../ders3/shaders/simplefs.glsl",GL_FRAGMENT_SHADER);
    program.link();
